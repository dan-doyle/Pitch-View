...
import ssl # ssl bug: certificate verify failed
...
def synthesize_mask(semantic_mask, disk_radius):
    ...
    disks = []
    while len(points):
        # WHAT DOES THE RANDOM SELECTION DO?
        # start = random.choice(points) # original
        start = points[np.random.choice(points.shape[0])] # my edit, seems to work
        dist = 10.
        success = True
        while dist > 1.:
...
def generate_extremities_prediction(image):
    # returns JSON of the extremity prediction
    lines_palette = [0, 0, 0]
    for line_class in SoccerPitch.lines_classes:
        lines_palette.extend(SoccerPitch.palette[line_class])

    # calib_net = SegmentationNetwork(
    #     "/Users/daniel/Desktop/Desktop - Daniel’s MacBook Pro/Projects/player-positions/app/homography_calibration/resources/soccer_pitch_segmentation.pth",
    #     "/Users/daniel/Desktop/Desktop - Daniel’s MacBook Pro/Projects/player-positions/app/homography_calibration/resources/mean.npy",
    #     "/Users/daniel/Desktop/Desktop - Daniel’s MacBook Pro/Projects/player-positions/app/homography_calibration/resources/std.npy"
    #     ) # local filepaths
    
    calib_net = SegmentationNetwork(
        "/app/homography_calibration/resources/soccer_pitch_segmentation.pth",
        "/app/homography_calibration/resources/mean.npy",
        "/app/homography_calibration/resources/std.npy"
        ) # docker filepaths
    ...
    default_resolution_height = 360
    extremities = get_line_extremities(skeletons, 40, default_resolution_width, default_resolution_height)

    prediction = extremities
    return json.dumps(prediction, indent=4)

if __name__ == "__main__":
    # Run 'python3 src/detect_extremities.py'
    ...
    parser.add_argument('-p', '--prediction', default="/Users/daniel/Desktop/Desktop - Daniel’s MacBook Pro/Projects/player-positions/sn-calibration/segmentation_predictions", required=False, type=str,
    ...
    calib_net = SegmentationNetwork(
        "/Users/daniel/Desktop/Desktop - Daniel’s MacBook Pro/Projects/player-positions/sn-calibration/resources/soccer_pitch_segmentation.pth",
        "/Users/daniel/Desktop/Desktop - Daniel’s MacBook Pro/Projects/player-positions/sn-calibration/resources/mean.npy",
        "/Users/daniel/Desktop/Desktop - Daniel’s MacBook Pro/Projects/player-positions/sn-calibration/resources/std.npy")
    ...
    # insert image directly into prediction
    img = "example"
    img_name = img + ".png"
    ...
    if args.masks:
        ...
        mask_file = os.path.join(output_prediction_folder, img_name)
        mask.save(mask_file)
    skeletons = generate_class_synthesis(semlines, 6)
    ...
    prediction_file = os.path.join(output_prediction_folder, f"extremities_{img}.json")
